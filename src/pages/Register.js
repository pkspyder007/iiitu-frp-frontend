...
export default function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const data = await axios.post("/users/register", {...user, cpassword: user.confirmPassword});
      ...
      <div className="lg:w-1/2 xl:max-w-screen-sm">
        <div className="pt-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
          <div className="cursor-pointer flex items-center">
            <div className="text-2xl pb-4 text-indigo-800 tracking-wide ml-2 font-semibold">
          ...
          <div className="mt-12">
            <form onSubmit={handleRegister}>
              ...
              <Input
                ...
                required={true}
              />
              <BtnLg title="Register" type="submit" />
            </form>
