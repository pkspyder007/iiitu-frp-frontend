    ...
    <form id="sopform">
      <div className="editor mx-auto mb-10 w-10/12 flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl">
        ...
        <label htmlFor="two" className="text-sm mb-1">
          <strong>
          2. Have you been punished during your studies at College/University? If so, give details.
        ...
        <label htmlFor="three" className="text-sm mb-1">
          <strong>
          3. Have you been punished during your services or convicted by Court of Law? If so, give details
          </strong>
          <span className="text-red-500">*</span>
        </label>
        <textarea
        ...
        <label htmlFor="four" className="text-sm mb-1">
          <strong>
          4. Were you at any time declared medically unfit or asked to submit your resignation or discharged or dismissed? If yes,give details.
          </strong>
          <span className="text-red-500">*</span>
        </label>
        <textarea
        ...
        <label htmlFor="five" className="text-sm mb-1">
          <strong>
          5. Do you have any court cases pending as one of the parties? If yes give details.
          </strong>
          <span className="text-red-500">*</span>
        </label>
        <textarea
